...
export const type = {
  eyebrow: { fontFamily: font.body, fontWeight: '600', fontSize: 14, letterSpacing: 0.3 } as TextStyle,
  ...
  meta: { fontFamily: font.body, fontWeight: '500', fontSize: 13, letterSpacing: 0.2 } as TextStyle,
